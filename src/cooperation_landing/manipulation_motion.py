"""Manipulation motion implementation."""
...
def build_state_machine():
    """Build the current task graph without executing it or starting monitors."""
    ...
    with sm_top:
        ...
        smach.StateMachine.add(
            'Start',
            Start(),
            transitions={'succeeded': 'TargetSearch', 'failed': 'Finish'},
            remapping={'object_state': 'object_state', 'home_x': 'home_x', 'home_y': 'home_y'},
        )
        ...
        with sm_target_search:
            smach.StateMachine.add(
                ...
                HorizontalScan(),
                transitions={
                    'succeeded': 'StateJudgment',
                    'need_vertical': 'VerticalScan',
                    'failed': 'failed',
                },
                remapping={
                    ...
                    'picking_marker_far': 'picking_marker_far',
                    'placing_marker_far': 'placing_marker_far',
                },
            )
            ...
            smach.StateMachine.add(
                'VerticalScan',
                VerticalScan(),
                transitions={'succeeded': 'StateJudgment', 'failed': 'HorizontalScan'},
                remapping={
                    'object_state': 'object_state',
                    'picking_position': 'picking_position',
                    'placing_position': 'placing_position',
            ...
            smach.StateMachine.add(
                ...
                StateJudgment(),
                transitions={
                    'succeed_docking': 'succeed_docking',
                    'succeed_detaching': 'succeed_detaching',
                },
                remapping={
                    'object_state': 'object_state',
        ...
        smach.StateMachine.add(
            ...
            sm_target_search,
            transitions={
                'succeed_docking': 'DockingManipulation',
                'succeed_detaching': 'DetachingManipulation',
                'failed': 'Finish',
            },
            remapping={
                'object_state': 'object_state',
        ...
        sm_docking_manipulation = smach.StateMachine(
        ...
        with sm_docking_manipulation:
            smach.StateMachine.add(
                'DockApproach',
                DockApproach(),
                transitions={'succeeded': 'DockManipulation', 'failed': 'DockHome'},
                remapping={
                    'object_state': 'object_state',
                    'picking_marker_far': 'picking_marker_far',
                    'placing_marker_far': 'placing_marker_far',
                    'picking_marker_near': 'picking_marker_near',
                    'placing_marker_near': 'placing_marker_near',
                },
            )
            ...
            smach.StateMachine.add(
                'DockManipulation',
                DockManipulation(),
                transitions={'succeeded': 'DockHome', 'failed': 'DockHome'},
                remapping={'object_state': 'object_state'},
            )

            smach.StateMachine.add(
                'DockHome',
                DockHome(),
                transitions={'succeed': 'succeed', 'finish': 'finish'},
                remapping={
                    'object_state': 'object_state',
                    'home_x': 'home_x',
                    'home_y': 'home_y',
        ...
        smach.StateMachine.add(
            'DockingManipulation',
            sm_docking_manipulation,
            transitions={'succeed': 'TargetSearch', 'finish': 'Finish'},
            remapping={
                'object_state': 'object_state',
                'picking_marker_far': 'picking_marker_far',
                'placing_marker_far': 'placing_marker_far',
        ...
        sm_detaching_manipulation = smach.StateMachine(
        ...
        with sm_detaching_manipulation:
            smach.StateMachine.add(
                'DetachApproach',
                DetachApproach(),
                transitions={'succeeded': 'DetachManipulation', 'failed': 'failed'},
                remapping={
                    'object_state': 'object_state',
                    'picking_marker_far': 'picking_marker_far',
                    'placing_marker_far': 'placing_marker_far',
                    'picking_marker_near': 'picking_marker_near',
                    'placing_marker_near': 'placing_marker_near',
                    'detaching_takeoff_threshold': 'detaching_takeoff_threshold',
                    'picking_position': 'picking_position',
                    'placing_position': 'placing_position',
                },
            )
            ...
            smach.StateMachine.add(
                'DetachManipulation',
                sm_detach_manipulation,
                transitions={'succeed': 'succeed', 'failed': 'failed'},
                remapping={
                    'object_state': 'object_state',
        ...
        smach.StateMachine.add(
            'DetachingManipulation',
            sm_detaching_manipulation,
            transitions={'succeed': 'PreciseLanding', 'failed': 'Finish'},
            remapping={
                'object_state': 'object_state',
                'picking_marker_far': 'picking_marker_far',
                'placing_marker_far': 'placing_marker_far',
        ...
        sm_precise_landing = smach.StateMachine(
            outcomes=['succeed', 'finish'], input_keys=['object_state', 'takeoff_position']
        )
        ...
        with sm_precise_landing:
            ...
            smach.StateMachine.add(
                'AlignAndLand',
                AlignAndLand(),
                transitions={'succeeded': 'succeed', 'failed': 'finish'},
            )
